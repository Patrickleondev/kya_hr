...
DASHBOARD_CHARTS = [
    ...
    {
        "name": "Entrées Matériel par Mois",
        "chart_type": "Count",
        "type": "Bar",
        "document_type": "PV Entree Materiel",
        "based_on": "date_entree",
        "time_interval": "Monthly",
        "timespan": "Last Year",
        "timeseries": 1,
        "color": "#22c55e",
...
NUMBER_CARDS = [
    ...
    {
        "label": "Entrées Matériel cette année",
        "document_type": "PV Entree Materiel",
        "function": "Count",
        "color": "#22c55e",
        "filters_json": '[["date_entree","Timespan","this year"],["docstatus","=",1]]',
    },
    {
