import frappe
from frappe.utils import getdate, today, add_days, get_first_day, get_last_day, formatdate
...
def get_columns(filters):
    ...
    if period == "Journalier":
        cols += [
            ...
            {"label": "Retard", "fieldname": "late_entry", "fieldtype": "Check", "width": 70},
            {"label": "Départ anticipé", "fieldname": "early_exit", "fieldtype": "Check", "width": 70},
        ]
    else:
        cols += [
            ...
            {"label": "Demi-journée", "fieldname": "half_day", "fieldtype": "Int", "width": 100},
...
def get_data(filters):
    ...
    if period == "Journalier":
        ...
        for emp in employees:
            ...
            emp["half_day"] = counts.get("Half Day", 0)
            emp["total_days"] = emp["present"] + emp["absent"] + emp["on_leave"] + emp["half_day"]
...
def get_chart(data, filters):
    ...
    if period == "Journalier":
        ...
        return {
            ...
            "type": "donut",
            "colors": ["#36a2eb", "#ff6384", "#ff9f40", "#4bc0c0", "#9966ff"],
        }
    else:
        departments = {}
        for row in data:
...
def get_summary(data):
    ...
    if "status" in (data[0] if data else {}):
        ...
        return [
            {"value": total, "label": "Total employés", "datatype": "Int"},
        ...
        return [
            {"value": total, "label": "Employés", "datatype": "Int"},
