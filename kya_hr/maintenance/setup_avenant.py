# -*- coding: utf-8 -*-
"""Circuit de l'avenant au contrat — Flux Avenant KYA (Brouillon → En attente DG
→ Signé ; Rejeter/Reprendre). Idempotent, AFTER_MIGRATE.

Réutilise les Workflow State / Action Master déjà posés par setup_documents_rh
(mêmes états). Ne crée que le Workflow propre au DocType Avenant Contrat KYA.
"""
import frappe
