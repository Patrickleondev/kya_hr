...
def force_workspaces():
    ...
    workspaces = [
        ...
        {"name": "Congés", "icon": "calendar", "module": "HRMS", "links": [
            {"label": "Mes Demandes", "type": "Shortcut", "link_type": "DocType", "link_to": "Leave Application"}
        ]}
    ]
    ...
    frappe.db.sql("delete from tabWorkspace where (for_user='Administrator' or for_user='admin') and public=0")
