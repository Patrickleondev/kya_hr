...
def get_context(context):
    """Controller Web Form PV Entrée Matériel.
    Circuit KYA: Livreur (tout employé) -> Magasin (Chargé des Stocks ou Responsable Stock).
    System Manager = override admin pour tests uniquement.
    """
    ...
    context.can_sign_livreur = state == "Brouillon"
