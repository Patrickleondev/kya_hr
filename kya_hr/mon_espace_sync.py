...
REQUEST_SPECS = [
    ...
    },
    {
        ...
        "employee_field": "owner",
        "date_fields": ["date_entree", "creation"],
        "audience": {"employee", "prestataire"},
        "icon": "📥",
    },
    {
        ...
        "employee_field": "owner",
        "date_fields": ["date_retour", "creation"],
        "audience": {"employee", "prestataire"},
        "icon": "↩️",
    },
    {
...
FORM_SPECS = [
    ...
    {"label": "PV Réception Matériel", "route": "pv-entree-materiel", "icon": "📥", "audience": {"employee", "prestataire"}},
    {"label": "Retour Matériel", "route": "retour-materiel", "icon": "↩️", "audience": {"employee", "prestataire"}},
